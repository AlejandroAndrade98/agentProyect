...
AI Workspace, AI Suggestions board, Synced Emails board/list, and Synced Calendar board/list now show compact guardrail disclosures instead of large always-visible blue guardrail cards.
